    ...
    <form method="post" action="{{ action('EventController@update', $event->id) }}">
        ...
        <div class="form-body mxn1">
            ...
            <div class="rel mb2 col col-12 px1">
                ...
                <input type="text" class="blk col-12 mb1 field" id="name" name="name" value="{{ old('name', $event->name) }}">
            </div>
            ...
            <div class="rel mb2 col col-12 px1">
                ...
                <input type="number" class="blk col-12 mb1 field" id="facebook" name="facebook" value="{{ old('facebook', $event->facebook) }}">
            </div>

            <div class="rel mb2 col col-12 px1">
                <label class="caps h5 abs" for="hashtag">Hashtag</label>
                <input type="text" class="blk col-12 mb1 field" id="hashtag" name="hashtag" value="{{ old('hashtag', $event->hashtag) }}">
            </div>

            <div class="rel mb2 col col-12 px1">
                <label class="caps h5 abs" for="description">Description</label>
                <textarea class="blk col-12 mb1 field" id="description" name="description">{{ old('description', $event->description) }}</textarea>
            </div>
